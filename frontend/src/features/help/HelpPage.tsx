...
const REFERENCE_SECTIONS = [
  ...
  },
  {
    ...
    text: 'В настройках можно скачать JSON со всеми своими проектами, статусами и задачами Tafel, включая архивные и старые экземпляры повторов. Экспорт не содержит профиль аккаунта и данные других сервисов Hof.',
  },
]
