# Contributing to Tafel

Thanks for considering a contribution. Tafel is a personal task/project
tracker and a pnpm workspace with two packages, `backend/` and `frontend/` —
